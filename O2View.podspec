...
s.homepage     = "https://github.com/liuhongjun719/O2View"
...
#s.source       = { :git => "https://github.com/liuhongjun719/O2View.git", :tag => version }

s.platform     = :ios, "9.0"          #支持的平台及版本，这里我们呢用swift，直接上9.0
s.requires_arc = true                 #是否使用ARC

s.source_files  = "O2View/*"    #OC可以使用类似这样"Classes/**/*.{h,m}"
